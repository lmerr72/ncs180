...
export function DetailCard({ icon: Icon, label, value, color, bg, mono }: {
    ...
    return (
      <div className="min-w-0 flex-1 basis-0 bg-card rounded-xl p-3 border border-border shadow-sm flex items-center gap-2.5 hover-elevate sm:rounded-2xl sm:p-5 sm:gap-4 lg:p-6 lg:gap-5">
